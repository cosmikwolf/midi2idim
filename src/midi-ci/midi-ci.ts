...
enum midi2_status_code {
    ...
    STATUS_PER_NOTE_RCC = 0x00,
    STATUS_PER_NOTE_ACC = 0x10,
    STATUS_RPN = 0x20,
    STATUS_NRPN = 0x30,
    STATUS_RELATIVE_RPN = 0x40,
    STATUS_RELATIVE_NRPN = 0x50,
    STATUS_PER_NOTE_PITCH_BEND = 0x60,
    STATUS_PER_NOTE_MANAGEMENT = 0xF0,
};
...
enum MIDI2_SUB_ID_2 {
    ...
    NAK = 0x7F,
    PROTOCOL_NEGOTIATION_INQUIRY = 0x10,
    PROTOCOL_NEGOTIATION_REPLY = 0x11,
    SET_NEW_PROTOCOL = 0x12,
    TEST_NEW_PROTOCOL_I2R = 0x13,
    TEST_NEW_PROTOCOL_R2I = 0x14,
    CONFIRM_NEW_PROTOCOL_ESTABLISHED = 0x15,
    PROFILE_INQUIRY = 0x20,
    PROFILE_INQUIRY_REPLY = 0x21,
    SET_PROFILE_ON = 0x22,
    SET_PROFILE_OFF = 0x23,
    PROFILE_ENABLED_REPORT = 0x24,
    PROFILE_DISABLED_REPORT = 0x25,
    PROFILE_SPECIFIC_DATA = 0x2F,
    PROPERTY_CAPABILITIES_INQUIRY = 0x30,
    PROPERTY_CAPABILITIES_REPLY = 0x31,
    PROPERTY_HAS_DATA_INQUIRY = 0x32,
    PROPERTY_HAS_DATA_REPLY = 0x33,
    PROPERTY_GET_DATA_INQUIRY = 0x34,
    PROPERTY_GET_DATA_REPLY = 0x35,
    PROPERTY_SET_DATA_INQUIRY = 0x36,
    PROPERTY_SET_DATA_REPLY = 0x37,
    PROPERTY_SUBSCRIBE = 0x38,
    PROPERTY_SUBSCRIBE_REPLY = 0x39,
    PROPERTY_NOTIFY = 0x3F,
}
enum MIDI2_CI_CAPABILITIES {
